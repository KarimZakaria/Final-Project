                ...
                <div class="col-lg-12">
                    <div class="breadcrumb_iner text-center">
                        <div class="breadcrumb_iner_item">
                            ...
                            <p>Home<span>/</span>{{$course->cat->name}}<span>/</span>{{$course->name}}</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 course_details_left">
                    ...
                    <div class="content_wrapper py-5 text-center text-muted">
                        {!! $course->desc !!} <!-- That He Understand To Enter HTML Data (tables , atrr , .......) -->
                    </div>
                </div>
                ...
                <div class="col-lg-4 right-contents">
                    ...
                    <div class="my-5">
                        ...
                        <form class="form-contact contact_form" action="{{route('Front.message.enroll')}}" method="post" id="contactForm">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                <input class="form-control" name="spec"  type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Your Spec'" placeholder = 'Enter Your Spec'>
                                </div>
                            </div>
                            </div>
