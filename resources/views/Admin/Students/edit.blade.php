			...
			<div class="wrap-login100">
				<div class="login100-form-title" style="background-image: url({{asset('asset/images/bg-01.jpg')}});">
					<span class="login100-form-title-1">
						<h5> {{$student->name}} Student Edit</h5>
					</span>
                </div>
                
                <form class="login100-form validate-form" method="POST" action="{{ route('Admin.Students.update') }}">
                    @csrf
                    <input type="hidden" name="id" value=" {{$student->id}} ">
					<div class="wrap-input100 validate-input m-b-26"  data-validate=" Name is required">
						<span class="label-input100">Stu-Name</span>
                        <input class="input100" type="text" name="name" value="{{$student->name}}" placeholder="Enter ur Name">
						<span class="focus-input100"></span>
                    </div>
                    
                    <div class="wrap-input100 validate-input m-b-26"  data-validate=" Email is required">
						<span class="label-input100">Email </span>
                        <input class="input100" type="email" name="email" value="{{$student->email}}" placeholder="Enter Email ">
						<span class="focus-input100"></span>
                    </div>
                    
                    <div class="wrap-input100 m-b-26"  >
						<span class="label-input100">Spec</span>
                        <input class="input100" type="text" name="spec" value="{{$student->spec}}" placeholder="Enter Spec">
						<span class="focus-input100"></span>
					</div>
                    <div class="d-flex justify-content-between">
                        ...
                        <a class="btn btn-info login100-form-btn bg-info ml-3" href="{{route('Admin.Students.index')}}">Back</a>
                    </div>
                </form>
			</div>
		</div>
