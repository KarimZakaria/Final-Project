    ...
    <div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
                ...
                <form class="login100-form validate-form" method="POST" enctype="multipart/form-data" action="{{ route('Admin.Trainer.store')}}">
                    @csrf
                    ...
                    <div class="wrap-input100 validate-input m-b-26"  data-validate="Speciality is required">
						...
						<input class="input100" type="text" name="spec" placeholder="Enter Your Speciality">
						<span class="focus-input100"></span>
                    </div>
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <a class="btn btn-info login100-form-btn bg-info ml-3" href="{{route('Admin.Trainer.index')}}">Back</a>
                    </div>
                </form>
			</div>
		</div>
