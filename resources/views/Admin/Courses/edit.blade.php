    ...
    <div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
                ...
                <form class="login100-form validate-form" method="POST" enctype="multipart/form-data" action="{{ route('Admin.Courses.update')}}">
                    @csrf
					...
					<div class="wrap-input100 validate-input m-b-26"  data-validate="Course Name is required">
						...
						<input class="input100" type="text" name="name" placeholder="Enter Course Name" value="{{$course->name}}">
                    ...
                    <div class="wrap-input100 validate-input m-b-26"  data-validate="Small Desc is required">
                        ...
                        <input class="input100" type="text" name="small_desc" value="{{$course->small_desc}}" placeholder="Enter Small Desc">
						<span class="focus-input100"></span>
                    </div>

                    <div class="wrap-input100 validate-input m-b-26"  data-validate="Description is required">
						<span class="label-input100">Description</span>
						<textarea rows="10" cols="30" class="input100" type="text" name="desc" placeholder="Enter Description">{{$course->desc}}</textarea>
						<span class="focus-input100"></span>
                    </div>

                    <div class="wrap-input100 validate-input m-b-26"  data-validate="Course Name is required">
						<span class="label-input100">Price</span>
						<input class="input100" type="number" name="price" value="{{$course->price}}" placeholder="Enter Price">
						<span class="focus-input100"></span>
                    </div>
                    
                    <img src="{{asset('Uploads/Courses/'. $course->img)}}" height="100px" class="mb-2">
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <a class="btn btn-info login100-form-btn bg-info ml-3" type="submit" href="{{route('Admin.Courses.index')}}">Back</a>
                    </div>
                </form>
			</div>
		</div>
