...
@section('title' , 'New Category Creation')
			...
			<div class="wrap-login100">
				<div class="login100-form-title" style="background-image: url({{asset('asset/images/bg-01.jpg')}});">
					<span class="login100-form-title-1">
						Create A New Categorey
					</span>
                </div>
                
                <form class="login100-form validate-form" method="POST" action="{{ route('Admin.Cat.store') }}">
                    @csrf
					<div class="wrap-input100 validate-input m-b-26"  data-validate="Category Name is required">
						...
						<input class="input100" type="text" name="name" placeholder="Enter Category Name">
